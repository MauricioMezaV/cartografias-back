...
- luego se crea el action
- se importa el action en el service y se agrega al actions
- luego te vas a api.service
- despues se pone "v1.`name de service`.action"
- finalmente se le asigna el alias en el api.service
